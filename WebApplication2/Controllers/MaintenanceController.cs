...
namespace WebApplication2.Controllers
{
    ...
    public class MaintenanceController : ControllerBase
    {
        ...
        {
            if (id != maintenance.id_maintenance)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Maintenance>> PostMaintenance(Maintenance maintenance)
        {
            ...
            return CreatedAtAction("GetMaintenance", new { id = maintenance.id_maintenance }, maintenance);
        }
        ...
        {
            return _context.Maintenance.Any(e => e.id_maintenance == id);
        }
    }
}
